...
echo "2. Run final performance report: python3 scripts/performance_test.py http://app.demo.gke/status --resolve app.demo.gke:$GATEWAY_IP --output stage4_post_upgrade.csv"
echo "--------------------------------------------------"
